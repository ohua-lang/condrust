...
def main(i_1):
    ...
    result_2_sender, result_2_receiver = mp.Pipe()
    tasks = [task_1, task_2, task_3, task_4, task_5, task_6, task_7, task_8, task_9, task_10, task_11]
    channels = [[e_0_0_sender, current_0_0_0_2_receiver, ctrlTrue_0_receiver], [ctrl_0_0_sender, d_1_sender], [flag_0_0_0_sender, c1_0_0_0_receiver], [result_0_0_1_sender], [result_2_sender, c_0_0_1_receiver, e_0_0_receiver, f_0_0_receiver], [c_0_0_0_sender, c_0_0_1_sender, flag_0_0_0_receiver], [c1_0_0_0_sender, c2_0_0_0_sender, d_1_receiver], [ctrlTrue_0_sender, ctrlFalse_0_sender, c_0_0_0_receiver], [current_0_0_0_2_sender, current_0_0_0_3_sender, c2_0_0_0_receiver], [f_0_0_sender, current_0_0_0_3_receiver, ctrlFalse_0_receiver], [result_0_1_0_sender, result_0_0_1_receiver, ctrl_0_0_receiver, result_2_receiver]]
    processes = []
    for task, channels in zip(tasks, channels):
        process = mp.Process(target=task, args=channels)
        processes.append(process)
