...
selectSf :: OhuaType ty Resolved -> Expr embExpr annot ty
...
ifSf :: OhuaType ty Resolved -> Expr embExpr annot ty
            ...
            case (trueBranch,falseBranch) of
              (Lambda trueIn trueBody, Lambda falseIn falseBody) | isUnit trueIn && isUnit falseIn -> do
                ...
                assertE (typeTrue == typeFalse) $
                        " Error: Types of branching expression do not match. Cannot decide the type of" <> 
